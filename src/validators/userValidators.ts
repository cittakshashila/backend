...
const UserSchema = z.object({
  ...
  clg_name: z
    .string()
    .min(4, "College Name should be atleast 4 characters")
    .max(50, "College Name should be atmost 50 characters"),
  phone_no: z.string().length(10, "Mobile number should be 10 digits long"),
});
...
export { createUserValidator, emailValidator, uuidValidator, UserSchema };
